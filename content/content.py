    ...
    "children": {
        ...
        "tools": {
            ...
            "description": (
                ...
                "гадание по дате, проверка истинности, погода и поиск по фотографии."
            ),
            "aliases": ["tools"],
            **sf7_button_icon("wrench.and.screwdriver"),
            "children": {
                ...
                "img_fortune": {
                    ...
                    "aliases": ["img_fortune", "fortune"],
                    "disable_web_page_preview": 1,
                    **sf7_button_icon("calendar"),
                    "children": {
                        "choose_date": {
                            "name": "Выбрать дату",
                            "callback_data": "img_fortune:months",
                            "button_style": "primary",
                            **sf7_button_icon("calendar"),
                        },
                    },
